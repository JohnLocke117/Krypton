...
class ObsidianThemeValues(private val settings: Settings) {
    ...
    // Design tokens from UiDefaults
    val IconSizeSmall: androidx.compose.ui.unit.Dp get() = org.krypton.config.UiDefaults.DEFAULT_ICON_SIZE_SMALL.dp
    val IconSizeMedium: androidx.compose.ui.unit.Dp get() = org.krypton.config.UiDefaults.DEFAULT_ICON_SIZE_MEDIUM.dp
    val IconSizeLarge: androidx.compose.ui.unit.Dp get() = org.krypton.config.UiDefaults.DEFAULT_ICON_SIZE_LARGE.dp
    
    val SidebarItemHeight: androidx.compose.ui.unit.Dp get() = org.krypton.config.UiDefaults.DEFAULT_SIDEBAR_ITEM_HEIGHT.dp
    val SidebarIndentPerLevel: androidx.compose.ui.unit.Dp get() = org.krypton.config.UiDefaults.DEFAULT_SIDEBAR_INDENT_PER_LEVEL.dp
    val SidebarHorizontalPadding: androidx.compose.ui.unit.Dp get() = org.krypton.config.UiDefaults.DEFAULT_SIDEBAR_HORIZONTAL_PADDING.dp
    val SidebarVerticalPadding: androidx.compose.ui.unit.Dp get() = org.krypton.config.UiDefaults.DEFAULT_SIDEBAR_VERTICAL_PADDING.dp
    val SidebarIconTextSpacing: androidx.compose.ui.unit.Dp get() = org.krypton.config.UiDefaults.DEFAULT_SIDEBAR_ICON_TEXT_SPACING.dp
    val SidebarChevronWidth: androidx.compose.ui.unit.Dp get() = org.krypton.config.UiDefaults.DEFAULT_SIDEBAR_CHEVRON_WIDTH.dp
    val SidebarSeparatorHeight: androidx.compose.ui.unit.Dp get() = org.krypton.config.UiDefaults.DEFAULT_SIDEBAR_SEPARATOR_HEIGHT.dp
    val SidebarSectionHeight: androidx.compose.ui.unit.Dp get() = org.krypton.config.UiDefaults.DEFAULT_SIDEBAR_SECTION_HEIGHT.dp
    val SidebarItemSpacing: androidx.compose.ui.unit.Dp get() = org.krypton.config.UiDefaults.DEFAULT_SIDEBAR_ITEM_SPACING.dp
