...
class RagActivationManager(
    ...
    suspend fun activateRag(
        ...
        try {
            ...
            val hasExistingData = if (vectorStore is org.krypton.data.rag.impl.ChromaDBVectorStore) {
    ...
    private suspend fun performIngestion(
        ...
        try {
            ...
            try {
                ...
                AppLogger.e("IngestionPipeline", "Ingestion Pipeline Failed: $errorMsg", e)
            ...
            if (changes.deletedFiles.isNotEmpty()) {
                ...
                for (deletedFile in changes.deletedFiles) {
                    try {
                        ...
                        if (vectorStore is org.krypton.data.rag.impl.ChromaDBVectorStore) {
