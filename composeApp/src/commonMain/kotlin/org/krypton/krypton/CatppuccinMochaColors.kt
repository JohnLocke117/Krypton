 ...
 * Official hex values from the Catppuccin Mocha theme.
 * 
 * This object provides strongly-named color constants that can be referenced
 * throughout the app. To change the theme later, update the hex values here.
 */
object CatppuccinMochaColors {
    // Accent colors
