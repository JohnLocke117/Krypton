 ...
 * 
 * **KMP Compatibility**: This implementation uses `org.intellij.markdown` which is a
 * Kotlin Multiplatform library. If platform-specific issues arise, this implementation
 * should be moved to platform-specific source sets (e.g., jvmMain) and replaced with
 * an interface-only definition in commonMain.
 */
