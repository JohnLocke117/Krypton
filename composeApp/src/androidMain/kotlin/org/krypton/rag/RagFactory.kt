...
/**
 * Android implementation of HTTP client engine factory.
...
/**
 * Android implementation of RAG component factory.
 */
actual fun createRagComponents(
    ...
    // On Android, embedder should always be provided from DI (GeminiEmbedder)
    ...
    // Create Android-specific indexer
    val indexer = AndroidIndexer(
